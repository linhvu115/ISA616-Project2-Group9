...
```
The most common responses for `survey_internships` and `survey_offers` are N/A, with 509 in total. Followed after this are those who performed 2 internships and received 1 job offer, with 371 results, and those who performed 1 internship and received 1 job offer is net, with 357 results. This dataframe sorts the count of responses for students in terms of the number of internships they had as well as the number of job offers they received in descending order.
...
data_major
```
We are interested in finding out more information about the concentration of internships and job offers by majors and minors. This dataframe sorts the count of responses from students in terms of the number of internships they had as well as the number of job offers they received in descending order by major and minor. The major that received more job offers are Finance, Accountancy and Marketing, and among those students, they only have one primary major and no minor.
...
```
Salary of survey respondents ranges from $20,800 to $95,000, with a mean value of $58,103 and a median value of $58,500. The most frequent salary amount that can be observed is $60,000, with 23 responses, which is followed by $50,000 - 21 responses, and $65,000 - 19 responses - subsequently. This is just the general overview of the `survey_salary` field, and we will take a deeper dive in terms of major and minor concentrtion, as well as job locations. 
...
data2 %>%
  ...
  arrange(desc(n))
```
When further subsetted into major and minor, the most common salary amount observed from `survey_salary` is $40,000 from students who majored in Marketing and had no minor. Those who majored in Accountancy and also had no minor had the second most responses, with a salary amount of $53,000. A similar trend can also be applied for students with a Finance major, and their salaries numbered $60,000, $65,000 and $70,000 respectively.
...
```
Ohio and Illinois received more responses than other locations when sorting `survey_salary` by count. However, these locations' average salaries are lower compared to the rest, around $56,067 and $59,660 respectively. The location with the highest average salary is Washington DC, with $79,067, only had three survey responses in total, which likely skewed the result to be above the rest. District of Colombia is similar, as there was only one response of $71,000, placing the state in second place. 
